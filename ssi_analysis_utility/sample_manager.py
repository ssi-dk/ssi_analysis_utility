...
# %% auto 0
__all__ = ['config', 'simone_testing', 'sample_data', 'input_manager', 'get_abs_file_path', 'get_single_sample_attributes',
           'single_test', 'single_test_assembly', 'single_test_input_folder', 'test_folder',
           'test_folder_with_metadata', 'samplesheet_test']
...
config = core.get_config(
    "/dpssi/home/scrsim/ssi_analysis_utility/ssi_analysis_utility/config/config.default.yaml"
)
...
def samplesheet_test():
    ...
    input_config["samplesheet"] = (
        "/dpssi/home/scrsim/ssi_analysis_utility/examples/samplesheet.tsv"
    )
    test = input_manager(input_config)
    print(test.__dict__)
