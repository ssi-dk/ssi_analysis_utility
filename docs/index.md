...
**MMASeq (Mixed Microbial Analysis on Sequencing data)** is a fully modular and  reproducible bioinformatics pipeline for bacterial isolate characterization developed at [Statens Serum Institute](https://www.ssi.dk/) as part of the  [MicrobeSeq Denmark project](https://microbeseq.ssi.dk/) 
